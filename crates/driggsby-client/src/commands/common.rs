...
pub fn public_view_contracts() -> Vec<PublicView> {
    vec![
        ...
        PublicView {
            ...
            columns: vec![
                view_column("group_key", "text"),
                view_column("account_key", "text"),
                view_column("merchant", "text"),
                view_column("cadence", "text"),
                view_column("typical_amount", "real"),
                view_column("currency", "text"),
                view_column("last_seen_at", "date"),
                view_column("next_expected_at", "date|null"),
                view_column("occurrence_count", "integer"),
                view_column("score", "real"),
                view_column("is_active", "integer"),
            ],
        },
        PublicView {
            ...
            columns: vec![
                ...
                view_column("amount", "real"),
                view_column("currency", "text"),
                view_column("reason_code", "text"),
                view_column("reason", "text"),
                view_column("score", "real"),
                view_column("severity", "text"),
            ],
        },
    ]
}
